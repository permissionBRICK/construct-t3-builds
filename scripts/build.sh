...
REPO_DIR="$(field constructDirectory)"
T3CODE_SOURCE_VERSION="$(field version)" T3CODE_INVENTORY="$(field inventory)"
CONSTRUCT_VERSION="$(field constructCommit)"
export REPO_DIR T3CODE_SOURCE_VERSION T3CODE_INVENTORY CONSTRUCT_VERSION T3CODE_CHANNEL=stable
